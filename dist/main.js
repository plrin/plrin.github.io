...
/******/ 	__webpack_require__.p = "/Users/ductandang/Projekte/uno/dist/";
/******/
...
function () {
  function PageController() {
    this.$$sectionSwitches = document.querySelectorAll('[data-section-switch]');
    this.$$ruleSwitches = document.querySelectorAll('[data-rule-switch]');
  }
  ...
  _proto.handleSection = function handleSection(id) {
    // remove active section class
    var oldActive = document.body.getAttribute('data-active');
    document.body.classList.remove(oldActive + '-active'); // activate new section class
    ...
    if ($newSection) {
      ...
      console.warn('no secion found with: ' + id);
    }
  };
...
var $ruleLine = document.querySelector('[data-rule-line]');

var scrollEvent = function scrollEvent() {
  var scrollController = new ScrollMagic__WEBPACK_IMPORTED_MODULE_1___default.a.Controller({
    globalSceneOptions: {
      duration: 0,
      triggerHook: 0.3
    }
...
var setRuleColor = function setRuleColor(e) {
  var $rule = e.target.triggerElement();
  var index = rulesArray.indexOf($rule);
  var modulo = index % 4;
